...
df_C1 = df_C1.drop_duplicates(ignore_index=True)
...
plt.savefig('comp_C1_A2_avg_rip_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_C1_A2_avg_cog_all.png')
plt.show()
...
plt.scatter(df_C1['RIP'], df_C1['COG'],
            color=colors[0], label='Case C1',
            marker='o', s=80, edgecolors='black', alpha=0.7)
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_C1_A2_rip_cog_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_C1_A2_avg_rip.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_C1_A2_avg_cog.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_C1_A2_rip_cog.png')
plt.show()
