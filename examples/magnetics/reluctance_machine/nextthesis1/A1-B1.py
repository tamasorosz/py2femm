...
plt.savefig('comp_A1_B1_avg_rip_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A1_B1_avg_cog_all.png')
plt.show()
...
plt.scatter(df_B1['RIP'], df_B1['COG'],
            color=colors[4], label='Case B1',
            marker='o', s=80, edgecolors='black', alpha=0.7)
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A1_B1_rip_cog_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A1_B1_avg_rip.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A1_B1_avg_cog.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A1_B1_rip_cog.png')
plt.show()
