...
df = pd.read_parquet('../eculidean/distance_df_case1_case3.parquet')

df_column = pd.read_csv('../ownclaster/case3_m2_s001_e1_average_max_doublecluster_backward_all_noiloc_low.csv')
...
result_df.to_parquet('similarity_case1_case3.parquet', index=False)