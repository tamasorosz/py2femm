...
with open('../raw/all_res_avg_case2_20250528_all_variable.csv', 'r') as f:
    df1 = pd.read_csv(f)

with open('../raw/all_res_cog_case2_20250528_all_variable.csv', 'r') as f:
    df2 = pd.read_csv(f)
...
# merged_x.to_csv('case2_cogging.csv', index=False)
...
# merged_x.to_csv('case2_average.csv', index=False)
