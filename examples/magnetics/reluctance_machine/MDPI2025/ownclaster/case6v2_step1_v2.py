...
df = pd.read_parquet('../eculidean/distance_df_case6v2_case6v2.parquet')
df_all = pd.read_csv('../refined/case6v2_all.csv')
...
out_path = ('../ownclaster/case6v2_m2_s001_e1_average_max_doublecluster_backward_all_noiloc_low_v2.csv')
os.makedirs(os.path.dirname(out_path), exist_ok=True)

for threshold in tqdm([round(x, 2) for x in [i * 0.01 for i in range(1, 26)]]):
