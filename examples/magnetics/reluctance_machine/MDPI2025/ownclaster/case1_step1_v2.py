...
out_path = ('../ownclaster/case1_m2_s001_e1_average_max_doublecluster_backward_all_noiloc_low_v2.csv')
os.makedirs(os.path.dirname(out_path), exist_ok=True)

for threshold in tqdm([round(x, 2) for x in [i * 0.01 for i in range(6, 26)]]):
