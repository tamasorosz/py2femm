...
# Read CSV files
dfA = pd.read_csv("caseAt.csv")
dfB = pd.read_csv("caseBt.csv")
...
for x_start, x_end, y_val in lines:
    ...
    plt.text(x_end+ 0.5, y_val-0.0275, f'{y_val} T', fontsize=20, color='gray', va='bottom')
...
plt.tight_layout()
plt.savefig('tangentialflux.png', dpi=300)
plt.show()