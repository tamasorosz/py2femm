...
#
# plt.figure(figsize=(8, 6))
# plt.scatter(range(len(sim_row)), diff_cog, label='Fognyomaték (B-A eset)', color=colors[5])
#
# a = len(diff_cog)
# b = len([i for i in diff_cog if i <= 0])
# c = len([i for i in diff_cog if i > 0])
...
#
# # Add title and labels
# plt.xlabel("Összehasonlított esetek indexe [-]", fontsize=18)
# plt.ylabel("Fognyomaték különbség [mNm]", fontsize=18)
#
# # Add grid behind the bars
# plt.grid(True, linestyle='--', linewidth=0.5, alpha=0.7)
# plt.gca().set_axisbelow(True)
...
# plt.legend(fontsize=18)
# plt.tight_layout()
# plt.savefig('diff_cog_case1_case6v2_hun.png', dpi=300)
# plt.show()
...
#
# plt.figure(figsize=(8, 6))
# plt.scatter(range(len(diff_avg)), diff_avg, label='Nyomaték középértéke (B-A eset)', color=colors[1])
#
# a = len(diff_avg)
# b = len([i for i in diff_avg if i <= 0])
# c = len([i for i in diff_avg if i > 0])
...
# plt.axhline(y=0, color='gray', linestyle='--', linewidth=1.5)
#
# plt.fill_between([-5, 624], 0, -400, color=colors[4], alpha=0.3)
# plt.text(610, -325, f"{round(b/a*100,1)}%",
#          fontsize=24, color="black",
#          ha="right", va="bottom")
#
# plt.fill_between([624, 1010], 0, 325, color=colors[3], alpha=0.3)
...
# # Add title and labels
# plt.xlabel("Összehasonlított esetek indexe [-]", fontsize=18)
# plt.ylabel("Nyomaték középérték különbség [mNm]", fontsize=18)
#
# # Add grid behind the bars
# plt.grid(True, linestyle='--', linewidth=0.5, alpha=0.7)
# plt.gca().set_axisbelow(True)
...
# plt.legend(fontsize=18, loc = 4)
# plt.tight_layout()
# plt.savefig('diff_avg_case1_case6v2_hun.png', dpi=300)
# plt.show()
# #
# # RIPPLE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# rip = pd.read_parquet('../diff_rip/diff_rip_df_case1_case6v2.parquet')
...
#
# plt.figure(figsize=(8, 6))
# plt.scatter(range(len(diff_rip)), diff_rip, label='Nyomatékhullámosság (B-A eset)', color=colors[2])
#
# a = len(diff_rip)
# b = len([i for i in diff_rip if i <= 0])
# c = len([i for i in diff_rip if i > 0])
...
# # Add title and labels
# plt.xlabel("Összehasonlított esetek indexe [-]", fontsize=18)
# plt.ylabel("Nyomatékhullámosság különbség [mNm]", fontsize=18)
#
# # Add grid behind the bars
# plt.grid(True, linestyle='--', linewidth=0.5, alpha=0.7)
# plt.gca().set_axisbelow(True)
...
# plt.legend(fontsize=18)
# plt.tight_layout()
# plt.savefig('diff_rip_case1_case6v2_hun.png', dpi=300)
# plt.show()
