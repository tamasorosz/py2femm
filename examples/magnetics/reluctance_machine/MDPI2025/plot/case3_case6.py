...
plt.figure(figsize=(8, 6))
plt.hist(X1_, bins=30, color=colors[6], edgecolor='black', alpha=0.85, label='case D - case C')

# Add title and labels
plt.xlabel("The width of the magnet gap next to the magnet [deg]", fontsize=18)
plt.ylabel("Frequency", fontsize=18)
...
plt.legend(fontsize=18)
plt.tight_layout()
plt.savefig('diff_X9X8_case3_case6.png', dpi=300)
plt.show()
