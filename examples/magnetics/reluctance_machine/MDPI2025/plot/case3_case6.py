...
#
# plt.fill_between([-5, 622], 0, -8, color=colors[3], alpha=0.3)
# plt.text(600, -7.5, f"{round(b/a*100,1)}%",
...
# plt.axhline(y=0, color='gray', linestyle='--', linewidth=1.5)
#
# plt.fill_between([-5, 334], 0, -205, color=colors[3], alpha=0.3)
...
plt.fill_between([-5, 625], 0, -25, color=colors[3], alpha=0.3)
plt.text(600, -22.5, f"{round(b/a*100,1)}%",
         fontsize=24, color="black",
         ha="right", va="bottom")

plt.fill_between([625, 760], 0, 15, color=colors[4], alpha=0.3)
plt.text(645, 12.5, f"{round(c/a*100,1)}%",
         fontsize=24, color="black",
         ha="left", va="top")
