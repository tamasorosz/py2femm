...
# COGGING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cog = pd.read_parquet('D:\Respositories\py2femm\examples\magnetics/reluctance_machine\MDPI2025\diff_cog\diff_cog_df_case1_case3.parquet')
...
plt.hist(diff_cog, bins=30, color=colors[2], edgecolor='black', alpha=0.85, label='case C - case A')
...
avg = pd.read_parquet('D:\Respositories\py2femm\examples\magnetics/reluctance_machine\MDPI2025\diff_avg\diff_avg_df_case1_case3.parquet')
...
plt.figure(figsize=(8, 6))
plt.hist(diff_avg, bins=30, color=colors[0], edgecolor='black', alpha=0.85, label='case C - case A')
...
# RIPPLE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
rip = pd.read_parquet('D:\Respositories\py2femm\examples\magnetics/reluctance_machine\MDPI2025\diff_rip\diff_rip_df_case1_case3.parquet')
...
plt.figure(figsize=(8, 6))
plt.hist(diff_rip, bins=30, color=colors[1], edgecolor='black', alpha=0.85, label='case C - case A')
