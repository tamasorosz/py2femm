...
plt.tight_layout()
plt.savefig('sensitivity_case1_avg.png', dpi=300)
plt.show()
...
plt.gca().invert_yaxis()  # Highest score at top
plt.tight_layout()
plt.savefig('sensitivity_case1_rip.png', dpi=300)
plt.show()
...
plt.xlabel('F-score', fontsize=18)
plt.ylabel('Features', fontsize=18)
plt.xticks(ticks=np.arange(0,16), fontsize=18)
plt.yticks(fontsize=18)
plt.grid(True)
plt.gca().set_axisbelow(True)
...
plt.gca().invert_yaxis()  # Highest score at top
plt.tight_layout()
plt.savefig('sensitivity_case1_cog.png', dpi=300)
plt.show()
