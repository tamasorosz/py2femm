...
# AVERAGE TORQUE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
feature_names = ['D1', 'D2', 'D3', 'D4', 'D5', 'D6', 'D7', 'D8', 'D9', 'D10', 'D11']
f_scores = f_avg
p_values = p_avg
...
plt.tight_layout()
plt.savefig('sensitivity_case6_avg.png', dpi=300)
plt.show()
...
plt.gca().invert_yaxis()  # Highest score at top
plt.tight_layout()
plt.savefig('sensitivity_case6_rip.png', dpi=300)
plt.show()
...
plt.xlabel('F-score', fontsize=18)
plt.ylabel('Features', fontsize=18)
plt.xticks(ticks=np.arange(0,7,1), fontsize=18)
plt.yticks(fontsize=18)
plt.grid(True)
plt.gca().set_axisbelow(True)
...
plt.gca().invert_yaxis()  # Highest score at top
plt.tight_layout()
plt.savefig('sensitivity_case6_cog.png', dpi=300)
plt.show()
