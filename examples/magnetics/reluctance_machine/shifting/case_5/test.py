...
#     x = calc_cogging.cogging(0, 22.1, 146.5, 1.0, 1.0, 3.0, 0.5, 1.5, 7.5, 1, 9, 2, 3, 9, 6, 10)
#
#     print(x[0], x[1])
#     plt.plot(x[2])
#     plt.show()
...
# if __name__ == "__main__":
#     x = calc_max_torque_angle.max_torque_angle(30, 22.1, 146.5, 1.0, 1.0, 3.0, 0.5, 1.5, 7.5, 1, 9, 2, 3, 9, 6, 10)
#
#     print(x[0])
#     plt.plot(x[1])
#     plt.show()
#
if __name__ == "__main__":
    x = calc_torque_avg_rip.torque_avg_rip(30, 22.1, 146.5, 1.0, 1.0, 3.0, 0.5, 1.5, 7.5, 1, 9, 2, 3, 9, 6, 10)
