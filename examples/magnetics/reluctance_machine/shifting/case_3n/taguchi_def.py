...
X1 = FactorL25("X1", [ang_m, ang_m-1*delta1, ang_m-2*delta1, ang_m-3*delta1, ang_m-4*delta1])  # ang_m
X2 = FactorL25("X2", [ang_mp, ang_mp-delta2, ang_mp-2*delta2, ang_mp-3*delta2, ang_mp-4*delta2])  # ang_mp
X3 = FactorL25("X3", [deg_m-2*delta3, deg_m-1*delta3, deg_m, deg_m+1*delta3, deg_m+2*delta3])  # deg_m
