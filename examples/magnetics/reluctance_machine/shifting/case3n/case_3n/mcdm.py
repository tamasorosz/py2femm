...
df_base = pd.read_csv('results/nsga2_case3_p50o25g100_top10.csv')

df_alts = df_base.iloc[:, [-2, -3, -4]]
...
ax.set_yticklabels(list(range(1, 11)), rotation=0, fontsize=14)


# plt.savefig('D:\py2femm\examples\magnetics/reluctance_machine\shifting\case_3n/figures/mcdm10.png', bbox_inches='tight')
plt.show()