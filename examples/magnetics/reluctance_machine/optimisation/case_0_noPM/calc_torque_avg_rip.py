...
def torque_avg_rip(J0, ang_co, deg_co, bd, bw, bh, bg):
    initial = calc_max_torque_angle.max_torque_angle(J0, ang_co, deg_co, bd, bw, bh, bg)
    ...
    current_file_path = os.path.abspath(__file__)
    folder_path = os.path.dirname(current_file_path)
    file_path = os.path.join(folder_path, f'results/all_res_avg_case0_20250125.csv')
