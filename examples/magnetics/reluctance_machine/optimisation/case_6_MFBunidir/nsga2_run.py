...
if __name__ == '__main__':
    ...
    file_path = os.path.join(folder_path, f'results/all_res_cog_case6_20250125.csv')
    ...
    file_path = os.path.join(folder_path, f'results/nsga2_case6_p100o100g200_var9_20250125.csv')
