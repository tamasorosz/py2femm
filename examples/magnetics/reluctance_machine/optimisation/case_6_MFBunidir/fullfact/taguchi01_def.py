...
df = pd.DataFrame([[float(0.00)] * len(cols)] * len(data), columns=cols)
df1 = pd.DataFrame([[float(0.00)] * len(cols)] * len(data), columns=cols)
df2 = pd.DataFrame([[float(0.00)] * len(cols)] * len(data), columns=cols)
