...
df_base = pd.read_csv('results/nsga2_case3_p50o50g100_obj7_20240807.csv')

df_alts = df_base.iloc[:, -4:-1]  # Specifies the average torque, the torque ripple and cogging torque in the .csv
