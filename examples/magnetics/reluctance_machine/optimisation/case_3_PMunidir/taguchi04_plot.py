...
plt.tight_layout()
plt.savefig(os.getcwd() + '/figures/' + 'taguchi_res_all_c3.png')
plt.show()
...
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig(os.getcwd() + '/figures/' + 'taguchi_res_avg_c3.png')
plt.show()
...
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig(os.getcwd() + '/figures/' + 'taguchi_res_rip_c3.png')
plt.show()
...
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig(os.getcwd() + '/figures/' + 'taguchi_res_cog_c3.png')
plt.show()
