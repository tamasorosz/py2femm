...
def torque_avg_rip(J0, ang_co, deg_co, bd, bw, bh, bgp, mh, ang_m, ang_mp):
    ...
    if ang_m != ang_mp:
        ...
        print(f'{ang_co, deg_co, bd, bw, bh, bgp, mh, ang_m, ang_mp}' +
        ...
        current_file_path = os.path.abspath(__file__)
        folder_path = os.path.dirname(current_file_path)
        file_path = os.path.join(folder_path, f'results/all_res_avg_case2_20250210.csv')
