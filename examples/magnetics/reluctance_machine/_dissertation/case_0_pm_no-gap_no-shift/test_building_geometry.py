...
variables = model.VariableParameters(output_folder_name='test',
                                     ...
                                     current_angle=0,
                                     rotor_position=0,
                                     X1_cut_off_barrier_opening_angle=24,
                                     X2_cut_off_barrier_curve_angle=130,
                                     X3_cut_off_barrier_internal_barrier_distance=0.5,
                                     X4_rib_width_upper=0.1,
                                     X5_internal_barrier_height_upper=3,
                                     X6_internal_barrier_lower_barrier_distance=2,
                                     X7_rib_width_lower=0.1,
                                     X8_internal_barrier_height_lower=4,
                                     X9_magnet_pocket_width=18,
                                     X10_magnet_pocket_height=2,
                                     X11_magnet_pocket_shift=0,
                                     X12_distance_magnet_pocket_internal_barrier=0,
                                     X13_magnet_width=0,
                                     X14_magnet_height=0,
                                     X15_magnet_shift=0
                                     )
