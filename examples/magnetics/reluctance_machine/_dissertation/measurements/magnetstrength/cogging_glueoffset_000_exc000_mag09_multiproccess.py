...
if __name__ == '__main__':
    ...
    femm.openfemm()
    femm.opendocument("steel_full_exc000_gl000_ferrite_x09.fem")
    ...
    with open("steel_full_exc000_gl000_mag09.csv", "w") as f:
        pass
    ...
    with open("steel_full_exc000_gl000_mag09.csv", "a") as file_out:
        for res in results:
            if res is not None:
