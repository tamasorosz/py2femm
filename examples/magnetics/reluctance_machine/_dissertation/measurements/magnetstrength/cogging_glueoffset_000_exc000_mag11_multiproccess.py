...
def process_simulation(i):
    try:
        ...
        femm.opendocument(f'fem_11/cog_{i}.fem')
...
if __name__ == '__main__':
    ...
    femm.openfemm()
    femm.opendocument("steel_full_exc000_gl000_ferrite_x11.fem")

    os.mkdir("fem_11")
    for i in values:
        femm.mi_saveas(f'fem_11/cog_{i}.fem')
    femm.closefemm()
    ...
    with open("steel_full_exc000_gl000_mag11.csv", "w") as f:
        pass
    ...
    with open("steel_full_exc000_gl000_mag11.csv", "a") as file_out:
        for res in results:
            if res is not None:
