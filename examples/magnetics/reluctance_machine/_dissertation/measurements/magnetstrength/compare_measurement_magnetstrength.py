...
sim = pd.read_csv('2D_FEMM_Steel_18mm_full_exc020_gl020_mag11.csv')
...
skew = rotate(list(sim["torque"]), 68)

simulation_data = rotate([(i+j)/1000 * 2 for i,j in zip(base, skew)], -45)
