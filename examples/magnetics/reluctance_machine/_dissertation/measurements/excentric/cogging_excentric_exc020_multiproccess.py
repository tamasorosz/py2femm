...
if __name__ == '__main__':
    ...
    femm.openfemm()
    femm.opendocument("steel_full_exc0.20.fem")
    ...
    with open("2D_FEMM_Steel_18mm_full_exc020_static.csv", "w") as f:
        pass
    ...
    with open("2D_FEMM_Steel_18mm_full_exc020_static.csv", "a") as file_out:
        for res in results:
            if res is not None:
