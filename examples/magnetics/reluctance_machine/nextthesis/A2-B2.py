...
plt.savefig('comp_A2_B2_avg_rip_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A2_B2_avg_cog_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A2_B2_rip_cog_all.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A2_B2_avg_rip.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A2_B2_avg_cog.png')
plt.show()
...
plt.legend(fontsize=16, loc=1, frameon=True)
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('comp_A2_B2_rip_cog.png')
plt.show()
